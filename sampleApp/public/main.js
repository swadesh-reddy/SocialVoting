...
/* harmony import */ var _admin_viewallusers_viewallusers_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../admin/viewallusers/viewallusers.component */ "./src/app/admin/viewallusers/viewallusers.component.ts");
/* harmony import */ var _admin_viewall_friend_request_viewall_friend_request_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../admin/viewall-friend-request/viewall-friend-request.component */ "./src/app/admin/viewall-friend-request/viewall-friend-request.component.ts");
/* harmony import */ var _admin_add_post_add_post_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../admin/add-post/add-post.component */ "./src/app/admin/add-post/add-post.component.ts");
/* harmony import */ var _admin_view_all_post_view_all_post_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../admin/view-all-post/view-all-post.component */ "./src/app/admin/view-all-post/view-all-post.component.ts");
/* harmony import */ var _admin_view_all_recommended_post_view_all_recommended_post_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../admin/view-all-recommended-post/view-all-recommended-post.component */ "./src/app/admin/view-all-recommended-post/view-all-recommended-post.component.ts");
/* harmony import */ var _admin_view_all_search_history_view_all_search_history_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../admin/view-all-search-history/view-all-search-history.component */ "./src/app/admin/view-all-search-history/view-all-search-history.component.ts");
/* harmony import */ var _admin_top_krating_chart_top_krating_chart_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../admin/top-krating-chart/top-krating-chart.component */ "./src/app/admin/top-krating-chart/top-krating-chart.component.ts");
/* harmony import */ var _adminlogin_adminlogin_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../adminlogin/adminlogin.component */ "./src/app/adminlogin/adminlogin.component.ts");
/* harmony import */ var _admin_admin_mainpage_admin_mainpage_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../admin/admin-mainpage/admin-mainpage.component */ "./src/app/admin/admin-mainpage/admin-mainpage.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'user', component: _user_user_component__WEBPACK_IMPORTED_MODULE_16__["UserComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
        children: [
    ...
    {
        path: 'admin', component: _admin_admin_component__WEBPACK_IMPORTED_MODULE_17__["AdminComponent"],
        children: [
            { path: 'adminmainpage', component: _admin_admin_mainpage_admin_mainpage_component__WEBPACK_IMPORTED_MODULE_26__["AdminMainpageComponent"] },
            { path: 'viewallusers', component: _admin_viewallusers_viewallusers_component__WEBPACK_IMPORTED_MODULE_18__["ViewallusersComponent"] },
            { path: 'viewallfriends', component: _admin_viewall_friend_request_viewall_friend_request_component__WEBPACK_IMPORTED_MODULE_19__["ViewallFriendRequestComponent"] },
            { path: 'addpost', component: _admin_add_post_add_post_component__WEBPACK_IMPORTED_MODULE_20__["AddPostComponent"] },
            { path: 'viewallpost', component: _admin_view_all_post_view_all_post_component__WEBPACK_IMPORTED_MODULE_21__["ViewAllPostComponent"] },
            { path: 'viewallrecommendedpost', component: _admin_view_all_recommended_post_view_all_recommended_post_component__WEBPACK_IMPORTED_MODULE_22__["ViewAllRecommendedPostComponent"] },
            { path: 'viewAllsearchhistory', component: _admin_view_all_search_history_view_all_search_history_component__WEBPACK_IMPORTED_MODULE_23__["ViewAllSearchHistoryComponent"] },
            { path: 'tophitkchart', component: _admin_top_krating_chart_top_krating_chart_component__WEBPACK_IMPORTED_MODULE_24__["TopKRatingChartComponent"] }
        ]
    },
    { path: 'adminlogin', component: _adminlogin_adminlogin_component__WEBPACK_IMPORTED_MODULE_25__["AdminloginComponent"] },
...
var MysearchhistoryComponent = /** @class */ (function () {
    function MysearchhistoryComponent(auth, friend) {
        this.auth = auth;
        this.friend = friend;
        this.histories = [];
    }
...
var SearchforfriendComponent = /** @class */ (function () {
    ...
    SearchforfriendComponent.prototype.loadProfile = function () {
        var _this = this;
        this.auth.getAllProfiles().subscribe(function (data) {
            console.log(data);
            _this.users = data;
    ...
    SearchforfriendComponent.prototype.onSearchFriend = function (username) {
        var _this = this;
        console.log(username);
        this.auth.getProfileById(username).subscribe(function (data) {
            console.log(data);
